...
Each course is a unique closed-spline layout with its own elevation profile, palette, sky, fog and themed scenery — from **Moose Meadows** and **Candy Canyon** through **Neon Nights**, **Volcano Vortex**, **Heaven's Highway** and **Space Station Zero**, all the way to the rainbow-road finale, **GO TEAM Galaxy**. Every race is 5 laps — earn a **medal (top 3)** to unlock the next circuit; best times are saved locally.
